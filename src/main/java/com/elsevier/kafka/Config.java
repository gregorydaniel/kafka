...
public class Config {
	...
	public EmbeddedKafkaBroker embeddedKafkaBroker() {
		return new EmbeddedKafkaBroker(1, false, "my_topic");
	}
	...
	@Bean
	public ConsumerFactory<Integer, String> consumerFactory(EmbeddedKafkaBroker embeddedKafka) {
	...
	@Bean
	public KafkaTemplate<Integer, String> kafkaTemplate(EmbeddedKafkaBroker embeddedKafka) {
